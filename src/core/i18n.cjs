...
(function (root, factory) {
  ...
  const LOCALES = {
    'en-us': {},
    'zh-hans': {
      'AI adjusted': 'AI 调整了', 'estimate(s) — review again': '项预计，请再核对',
      'on break': '休息中', 'so far': '已进行',
      'working (broken line)': '工作中（虚线）', 'break / idle (flat)': '休息/空闲（平线）',
      'plan pace': '计划节奏', 'done node': '完成节点', 'overwork tint': '超时染色',
      'tasks done': '完成任务', 'planned vs delivered': '计划 vs 已完成', 'breaks taken': '休息次数',
      'days tracked': '记录天数', 'hung': '挂起', 'planned': '计划', 'actual work': '实际工作',
      'est. bias': '估计偏差', 'overwork days': '超时天数', 'break time': '休息时长', 'longest stretch': '最长连续',
      'task': '任务', 'status': '状态', 'est': '预计', 'actual': '实际', 'finished': '完成时间',
      'AI error': 'AI 出错', 'AI thinking…': 'AI 思考中…',
      'templated text · findings from local rules': '模板文本 · 本地规则产出',
      'always open': '默认展开',
    ...
    'zh-hant': {
      'AI adjusted': 'AI 調整了', 'estimate(s) — review again': '項預計，請再核對',
      'on break': '休息中', 'so far': '已進行',
      'working (broken line)': '工作中（虛線）', 'break / idle (flat)': '休息/空閒（平線）',
      'plan pace': '計劃節奏', 'done node': '完成節點', 'overwork tint': '超時染色',
      'tasks done': '完成任務', 'planned vs delivered': '計劃 vs 已完成', 'breaks taken': '休息次數',
      'days tracked': '記錄天數', 'hung': '掛起', 'planned': '計劃', 'actual work': '實際工作',
      'est. bias': '估計偏差', 'overwork days': '超時天數', 'break time': '休息時長', 'longest stretch': '最長連續',
      'task': '任務', 'status': '狀態', 'est': '預計', 'actual': '實際', 'finished': '完成時間',
      'AI error': 'AI 出錯', 'AI thinking…': 'AI 思考中…',
      'templated text · findings from local rules': '模板文本 · 本地規則產出',
      'always open': '默認展開',
